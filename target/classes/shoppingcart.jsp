          ...
          <div class="col-md-4">
            <div class="card mb-4">
              ...
              <div class="card-body">
				...
				<form style="display: flex;justify-content: end;margin-top:30px" id="CheckoutForm" action="Checkout" method="get">				
                <button type="submit" class="btn btn-primary btn-lg btn-block"  role="button">
                  Go to checkout
                </button>
                </form>
              </div>
