					...
					<div class="row">
						<div class="d-flex justify-content-start align-items-center">
							<div class="d-flex align-items-center" style="padding: 15px">
								<a class="backProduct" href="javascript: history.go(-1)"
						...
						<div class="col-md-6">
							<div class="images p-3">
								...
								<div
									class="thumbnail mx-4 d-flex justify-content-start gap-2 text-center">
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="product p-4" style="margin-left: 30px">
								...
								<div class="mt-4 mb-3">
									...
									<div id="price-box"
										class="price d-flex flex-row align-items-center gap-2">
									</div>
								</div>
								<hr class="decription" />
								...
								<div class="sizes mb-2">
									...
									<div id="size-select" class="d-flex gap-2"></div>
								</div>
								<div class="quantity">
						...
						<div class="feedbackProduct" style="margin-left: 30px; width: 90%">
							<hr style="width: 100%" class="decription" />
							<h5 style="margin: 20px 0px" class="text-uppercase">Đánh giá
								của khách hàng</h5>
