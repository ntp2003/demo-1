		...
		<div class="container">
			<div class="row mb-5">
				<div class="col-md-8 col-xl-6 text-center mx-auto">
					<h2 style="color: var(--bs-body-bg);">Log in</h2>
					<p class="w-lg-50" style="color: var(--bs-body-bg);">Curae
						hendrerit donec commodo hendrerit egestas tempus, turpis facilisis
				...
				<div class="col-md-6 col-xl-4">
					<div class="card mb-5">
						<div class="card-body d-flex flex-column align-items-center">
							...
							<form class="text-center" action="/admin/Login" method="post">
								<div class="mb-3">
